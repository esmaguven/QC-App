...
function _setImgPreview(dataUrl) {
  _tmImgData = dataUrl;
  document.getElementById('tm-img-thumb').src = dataUrl;
  document.getElementById('tm-img-preview').style.display = '';
  document.getElementById('tm-img-placeholder').style.display = 'none';
  document.getElementById('tm-img-rm').style.display = '';
}

function _rmImg() {
  _tmImgData = null;
  const thumb = document.getElementById('tm-img-thumb');
  if (thumb) thumb.src = '';
  const prev = document.getElementById('tm-img-preview');
  if (prev) prev.style.display = 'none';
  const ph = document.getElementById('tm-img-placeholder');
  if (ph) ph.style.display = '';
  const rmBtn = document.getElementById('tm-img-rm');
  if (rmBtn) rmBtn.style.display = 'none';
  const inp = document.getElementById('tm-img-input');
  if (inp) inp.value = '';
}
